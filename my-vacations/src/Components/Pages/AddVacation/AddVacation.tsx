...
function AddVacation(): JSX.Element {
    ...
    const schema: ZodType<FormData> = z.object({
        ...
        startDate: z.coerce.date().refine((data) => data >= today, {message: 'Start date must be today or in the future'}),
    ...
    return (
        <div className="AddVacation">
            ...
            <Typography variant="h4">
                Add Vacation <FontAwesomeIcon icon={faUmbrellaBeach} color="#FFC857"/>
                </Typography>
            ...
            <div className="dateDiv">
                ...
                <TextField type="date"
                {...register("startDate", {valueAsDate: true})} error={!!errors.startDate} helperText={errors.startDate?.message} 
                onBlur={() => trigger('startDate')}/>
                <Typography variant="subtitle2" >End Date</Typography>
                <TextField type="date"
                {...register("endDate", {valueAsDate: true})} error={!!errors.endDate} helperText={errors.endDate?.message}
            ...
            <div className="fileInput" onClick={handleClick}>
                ...
                {image ? <img src={image} width={'100%'} height={'100%'} alt={File.name}/> : <MdCloudUpload size={50} color="#0075A2"/> }
            ...
            <Button variant="contained" size="large" color="secondary" type="submit"><Typography>Add Vacation</Typography></Button> <br />
            </form>
            </ThemeProvider>
        </div>
    );
